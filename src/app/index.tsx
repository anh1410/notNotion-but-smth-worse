...
const CHECKER_BORDER_URL = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADAAAAAwCAIAAADYYG7QAAAAY0lEQVR4nO3WIQ4AIAzFUD73v/NwKJYqAqJPkokGsSyjUVXH9yRX52cX9IpBxCBiEMmrfdPNf/dDBhGDiEHkvAyG99BmEDGIGES8h4hBxCBiEPEeIgYRg4hBxHuIGEQMIgaRBdLLNlLD5OhWAAAAAElFTkSuQmCC";

function checkerBorder(width: number = 10) {
  return {
    borderStyle: 'solid' as const,
    borderWidth: width,
    borderColor: 'transparent',
    borderImageSource: `url('${CHECKER_BORDER_URL}')`,
    borderImageSlice: '16',
...
export default function HomeScreen() {
  ...
  const styles: Record<string, React.CSSProperties> = {
    app: {
      minHeight: '100vh',
      background: '#23C7B9',
      backgroundImage: 'radial-gradient(circle, #1fa89c 1px, transparent 1px)',
    ...
    nnRow: {
      ...
      gap: 10,
      padding: '8px 0',
      borderBottom: '1px dashed #6b4a36',
    },
    nnCheck: {
      width: 22,
      height: 22,
      border: '2px solid #23C7B9',
      cursor: 'pointer',
      flexShrink: 0,
      display: 'flex',
      alignItems: 'center',
